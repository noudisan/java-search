package com.dztt.elasticsearch.service.base;

import com.dztt.elasticsearch.model.entity.UserInfo;
...
public class DocumentService {
    ...
    public Object existsDocument() {
        ...
        try {
            // 获取请求对象
            GetRequest getRequest = new GetRequest("dztt-user", "doc", "1");
            // 是否获取源码内容
    ...
    public Object addDocument() {
        ...
        try {
            // 创建索引请求对象
            IndexRequest indexRequest = new IndexRequest("dztt-user", "doc", "1");
            // 创建用户信息
    ...
    public Object updateDocument() {
        ...
        try {
            // 创建索引请求对象
            UpdateRequest updateRequest = new UpdateRequest("dztt-user", "doc", "1");
            // 设置用户更新信息
            UserInfo userInfo = new UserInfo();
    ...
    public Object deleteDocument() {
        ...
        try {
            // 创建删除请求对象
            DeleteRequest deleteRequest = new DeleteRequest("dztt-user", "doc", "1");
            // 执行删除文档
