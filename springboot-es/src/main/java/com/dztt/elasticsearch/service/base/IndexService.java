...
public class IndexService {
    ...
    public Object createIndex() {
        ...
        try {
            ...
            CreateIndexRequest request = new CreateIndexRequest("dztt-user", settings);
    ...
    public Object deleteIndex() {
        ...
        try {
            // 新建删除索引请求对象
            DeleteIndexRequest request = new DeleteIndexRequest("dztt-user");
            // 执行删除索引
